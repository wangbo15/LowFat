...
@.str = private constant [11 x i8] c"tmp_main_0\00", align 1
@.str.1 = private constant [9 x i8] c"argc#i32\00", align 1
...
; <label>:7:                                      ; preds = %2
  ...
  call void (i8*, i8*, i8*, i32, ...) @lowfat_iof_error(i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @0 to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), i32 0), !dbg !22
  call void @__ubsan_handle_add_overflow(i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @0 to i8*), i64 %8, i64 %9) #3, !dbg !22, !nosanitize !2
