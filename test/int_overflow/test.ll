...
%LOWFAT_GLOBAL_WRAPPER.2 = type <{ [8 x i8], [8 x i8] }>

@0 = private unnamed_addr global { { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* } { { [7 x i8]*, i32, i32 } { [7 x i8]* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER, %LOWFAT_GLOBAL_WRAPPER* @LOWFAT_GLOBAL_WRAPPER_.src, i32 0, i32 1), i32 5, i32 5 }, { i16, i16, [6 x i8] }* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER.0, %LOWFAT_GLOBAL_WRAPPER.0* @LOWFAT_GLOBAL_WRAPPER_, i32 0, i32 1) }, section "lowfat_section_32", align 32
@LOWFAT_GLOBAL_WRAPPER_.src = private global %LOWFAT_GLOBAL_WRAPPER <{ [9 x i8] zeroinitializer, [7 x i8] c"test.c\00" }>, section "lowfat_section_16", align 16
...
@LOWFAT_GLOBAL_WRAPPER_.str = private global %LOWFAT_GLOBAL_WRAPPER.2 <{ [8 x i8] zeroinitializer, [8 x i8] c"FINISH\0A\00" }>, section "lowfat_section_16", align 16
...
; <label>:7:                                      ; preds = %2
  ...
  call void (i8*, i8*, i8*, ...) @lowfat_iof_error(i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @0 to i8*), i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @0 to i8*), i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @0 to i8*)), !dbg !22
  call void @__ubsan_handle_add_overflow(i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @0 to i8*), i64 %8, i64 %9) #4, !dbg !22, !nosanitize !2
  br label %10, !dbg !22, !nosanitize !2

; <label>:10:                                     ; preds = %7, %2
  call void @llvm.dbg.value(metadata i32 %4, i64 0, metadata !18, metadata !14), !dbg !19
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER.2, %LOWFAT_GLOBAL_WRAPPER.2* @LOWFAT_GLOBAL_WRAPPER_.str, i32 0, i32 1, i32 0)), !dbg !24
  ret i32 0, !dbg !25
}
...
declare void @lowfat_iof_error(i8*, i8*, i8*, ...)
...
!24 = !DILocation(line: 7, column: 3, scope: !6)
!25 = !DILocation(line: 8, column: 3, scope: !6)
