...
%LOWFAT_GLOBAL_WRAPPER = type <{ [9 x i8], [7 x i8] }>
%LOWFAT_GLOBAL_WRAPPER.0 = type <{ [6 x i8], { i16, i16, [6 x i8] } }>
%LOWFAT_GLOBAL_WRAPPER.3 = type <{ [12 x i8], [4 x i8] }>
%LOWFAT_GLOBAL_WRAPPER.4 = type <{ [12 x i8], [4 x i8] }>

@0 = private unnamed_addr global { { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* } { { [7 x i8]*, i32, i32 } { [7 x i8]* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER, %LOWFAT_GLOBAL_WRAPPER* @LOWFAT_GLOBAL_WRAPPER_.src, i32 0, i32 1), i32 5, i32 11 }, { i16, i16, [6 x i8] }* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER.0, %LOWFAT_GLOBAL_WRAPPER.0* @LOWFAT_GLOBAL_WRAPPER_, i32 0, i32 1) }, section "lowfat_section_32", align 32
@1 = private unnamed_addr global { { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* } { { [7 x i8]*, i32, i32 } { [7 x i8]* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER, %LOWFAT_GLOBAL_WRAPPER* @LOWFAT_GLOBAL_WRAPPER_.src, i32 0, i32 1), i32 13, i32 11 }, { i16, i16, [6 x i8] }* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER.0, %LOWFAT_GLOBAL_WRAPPER.0* @LOWFAT_GLOBAL_WRAPPER_, i32 0, i32 1) }, section "lowfat_section_32", align 32
@LOWFAT_GLOBAL_WRAPPER_.src = private global %LOWFAT_GLOBAL_WRAPPER <{ [9 x i8] zeroinitializer, [7 x i8] c"flow.c\00" }>, section "lowfat_section_16", align 16
@LOWFAT_GLOBAL_WRAPPER_ = private global %LOWFAT_GLOBAL_WRAPPER.0 <{ [6 x i8] zeroinitializer, { i16, i16, [6 x i8] } { i16 0, i16 11, [6 x i8] c"'int'\00" } }>, section "lowfat_section_16", align 16
@LOWFAT_GLOBAL_WRAPPER_.str = private global %LOWFAT_GLOBAL_WRAPPER.3 <{ [12 x i8] zeroinitializer, [4 x i8] c"%u\0A\00" }>, section "lowfat_section_16", align 16
@LOWFAT_GLOBAL_WRAPPER_.str.1 = private global %LOWFAT_GLOBAL_WRAPPER.4 <{ [12 x i8] zeroinitializer, [4 x i8] c"%d\0A\00" }>, section "lowfat_section_16", align 16
@.str = private constant [2 x i8] c"a\00", align 1
@.str.2 = private constant [2 x i8] c"b\00", align 1
...
; <label>:7:                                      ; preds = %2
  ...
  call void @__ubsan_handle_sub_overflow(i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @0 to i8*), i64 %8, i64 %9) #4, !dbg !17, !nosanitize !2
...
; <label>:7:                                      ; preds = %2
  ...
  call void (i8*, i8*, i8*, i32, ...) @lowfat_iof_error(i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @1 to i8*), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0), i32 0), !dbg !37
  call void @__ubsan_handle_add_overflow(i8* bitcast ({ { [7 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @1 to i8*), i64 %8, i64 %9) #4, !dbg !37, !nosanitize !2
...
define i32 @main() #0 !dbg !48 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER.3, %LOWFAT_GLOBAL_WRAPPER.3* @LOWFAT_GLOBAL_WRAPPER_.str, i32 0, i32 1, i32 0), i32 %1), !dbg !54
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds (%LOWFAT_GLOBAL_WRAPPER.4, %LOWFAT_GLOBAL_WRAPPER.4* @LOWFAT_GLOBAL_WRAPPER_.str.1, i32 0, i32 1, i32 0), i32 %3), !dbg !58
  ret i32 0, !dbg !59
}
...
declare void @lowfat_iof_error(i8*, i8*, i8*, i32, ...)
